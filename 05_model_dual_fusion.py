...
from config_new import compute_vol_series, CONTEXT_LEN, TRAIN_SPLIT_DATE, CHRONOS_MODEL, RAW_PRICES_DIR, PROC_EMBED_DIR, RESULTS_DIR, TICKERS, N_SEC_PCA, HORIZON, THRESHOLD_MULTIPLIER_DUAL, triple_barrier_label_v2, calculate_financial_metrics
...
def main():
    ...
    for ticker in TICKERS:
        ...
        for i in range(start_idx, len(df) - HORIZON):
            ...
            yt = triple_barrier_label_v2(actual_path, row[close_col], row['vol'], horizon=HORIZON)
